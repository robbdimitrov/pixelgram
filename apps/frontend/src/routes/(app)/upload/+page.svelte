...
<div class="mx-auto max-w-5xl">
  <div class="rounded-2xl border border-base-300 bg-base-100 text-base-content overflow-hidden shadow-xl shadow-slate-900/5">
    ...
    >
      <div class="grid min-h-[34rem] md:grid-cols-[minmax(0,1fr)_22rem]">
        ...
        >
          {#if imagePreview}
            <div class="flex w-full max-w-[42rem] flex-col gap-4">
              ...
              <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <p class="text-sm text-base-content/60">This is how your photo will appear in the feed.</p>
                <button
                  type="button"
          ...
          {:else}
            ...
            >
              ...
              <span class="max-w-xs text-sm leading-6 text-base-content/60">Choose a JPEG, PNG, GIF, or WEBP. Large images are resized automatically.</span>
              <span class="btn btn-sm btn-neutral min-h-10 rounded-full px-5 font-bold">Select from computer</span>
            </label>
          {/if}
        ...
        <div class="flex flex-col border-t border-base-300 bg-base-200/60 md:border-l md:border-t-0">
          <div class="flex items-center justify-between gap-3 border-b border-base-300 px-6 py-4 sm:px-8">
          ...
          <div class="border-t border-base-300 px-6 py-4 text-sm leading-6 text-base-content/60 sm:px-8">
